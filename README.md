...
Windows 用户可以直接下载当前体验版：[CC Panel 0.1.8 安装包](./CC%20Panel_0.1.8_x64-setup.exe)。没有 API Key 时也可以直接使用“演示模式”；只有真实 Agent 对话才需要本机已安装并登录官方 claude CLI。
...
- 在 CC Panel 自己的应用数据目录创建 hello_用户ID.html，展示文件内容和安全预览。
